...
public class FooterComponent implements Component {
	...
	public Object unpack(Element element, Map source, Map preDefine)
		 ...
		 * <!ATTLIST footer align CDATA "RIGHT">
		 * <!ATTLIST footer isDisplayPage CDATA #IMPLIED>
		...
		if(className == null || className.trim().equals("")) { 
			...
			return this.makeFooter(align, vBefore, vAfter,isDisplayPage);
		}else { 
	...
	private HeaderFooter makeFooter(String align,Phrase before,Phrase after,String isDisplayPage){
		...
		if(isDisplayPage.equals("FALSE")){
			footer = new HeaderFooter(before,false);
		}else { 
			footer = new HeaderFooter(before,after);
		}
		footer.setBorder(Rectangle.NO_BORDER);
		footer.setAlignment(vAlign);
		return footer;
	}
}
